...
class TestPrograms(TestBaseClientDBClass):
    ...
    async def test_create_program_files_it_under_its_faculty(self):
        faculty = await create_test_faculty(FacultyCreationFactory.build(), self.dynamo_client)
        program = ProgramCreationFactory.build(faculty_id=faculty.id)
    ...
    async def test_create_program_reserves_its_name(self):
        faculty = await create_test_faculty(FacultyCreationFactory.build(), self.dynamo_client)
        program = ProgramCreationFactory.build(faculty_id=faculty.id)
    ...
    async def test_create_program_rejects_duplicate_name_in_the_same_faculty(self):
        faculty = await create_test_faculty(FacultyCreationFactory.build(), self.dynamo_client)
        program = ProgramCreationFactory.build(faculty_id=faculty.id)
    ...
    async def test_create_program_allows_the_same_name_in_another_faculty(self):
    ...
    async def test_create_program_rejects_name_differing_only_in_case_or_spacing(self):
        faculty = await create_test_faculty(FacultyCreationFactory.build(), self.dynamo_client)
    ...
    async def test_create_program_strips_padding_from_its_name(self):
        faculty = await create_test_faculty(FacultyCreationFactory.build(), self.dynamo_client)
    ...
    async def test_create_program_rejects_a_whitespace_only_name(self):
        faculty = await create_test_faculty(FacultyCreationFactory.build(), self.dynamo_client)
        program = ProgramCreationFactory.build(faculty_id=faculty.id)
    ...
    async def test_create_program_rejects_unknown_faculty(self):
    ...
    async def test_list_programs(self):
        faculty = await create_test_faculty(FacultyCreationFactory.build(), self.dynamo_client)
    ...
    async def test_list_programs_skips_other_entities(self):
        faculty = await create_test_faculty(FacultyCreationFactory.build(), self.dynamo_client)
    ...
    async def test_delete_program_frees_its_name(self):
        faculty = await create_test_faculty(FacultyCreationFactory.build(), self.dynamo_client)
        created = await create_test_program(faculty.id, self.dynamo_client)
    ...
    async def test_delete_program_with_dependants(self):
        faculty = await create_test_faculty(FacultyCreationFactory.build(), self.dynamo_client)
        created = await create_test_program(faculty.id, self.dynamo_client)
    ...
    async def test_delete_program_missing(self):
